...
const Footer = () => {
  return (
    <>
      <footer className="relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-blue-950 pt-10">
                ...
                <div className="sm:col-span-2 lg:col-span-1">
                 <h1 className='text-3xl text-white font-bold'>
                    ...
                    <p className="text-sm/7 mt-6">
                        Bazzar is a free and open-source UI component library with over 340+
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 border-t mt-6 border-slate-200">
                <p className="text-center">
                    Copyright 2025 © <a href="#">Bazzar</a> All Right Reserved.
                </p>
